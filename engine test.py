...
from helpers import pos_to_representation, rep_to_move, move_to_rep, custom_reset, custom_step, custom_step_DQN, evaluate_pos, evaluate
...
Fen = '1k6/8/2K5/2R5/8/8/8/8 w - - 0 1'
...
print(summary(policy_net, input_size=(3,8,8)))
    ...
    for t in count():
        ...
        if obs.turn:
            ...
            if done:
                ...
                obs, reward_t1, done, info_t1 = env.step(env, best_move_black)
                new_state = pos_to_representation(obs) #.flatten()
